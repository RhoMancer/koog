 ...
 *
 * @constructor Creates a new instance of [StructuredOutputParsingException].
 ...
 */
public class StructuredOutputParsingException(message: String, cause: Exception?) : Exception(message, cause)
