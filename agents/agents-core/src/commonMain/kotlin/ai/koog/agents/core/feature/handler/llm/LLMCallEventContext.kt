...
public data class LLMCallStartingContext(
    ...
    override val eventType: AgentLifecycleEventType = AgentLifecycleEventType.LLMCallStaring
}
...
@Deprecated(
    message = "Scheduled for removal. Use LLMCallStartingContext instead",
    replaceWith = ReplaceWith("LLMCallStartingContext")
)
public typealias BeforeLLMCallContext = LLMCallStartingContext

@Deprecated(
    message = "Scheduled for removal. Use LLMCallCompletedContext instead",
    replaceWith = ReplaceWith("LLMCallCompletedContext")
)
public typealias AfterLLMCallContext = LLMCallCompletedContext
