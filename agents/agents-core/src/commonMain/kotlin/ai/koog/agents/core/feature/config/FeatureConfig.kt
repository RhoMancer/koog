...
public abstract class FeatureConfig {
    ...
    private var _eventFilter: (AgentEventHandlerContext) -> Boolean = { true }
     ...
     */
    public val eventFilter: (AgentEventHandlerContext) -> Boolean
        get() = _eventFilter
     ...
     * ```
     */
    public fun setEventFilter(filter: (AgentEventHandlerContext) -> Boolean) {
        _eventFilter = filter
    }
}
