...
public class ToolExecutionEventHandler {
    /**
     * A variable of type [ToolExecutionStartingHandler] used to handle tool call operations.
     ...
     */
    public var toolExecutionStartingHandler: ToolExecutionStartingHandler =
        ToolExecutionStartingHandler { _ -> }
     ...
     */
    public var toolValidationFailedHandler: ToolValidationFailedHandler =
        ToolValidationFailedHandler { _ -> }
     ...
     */
    public var toolExecutionFailedHandler: ToolExecutionFailedHandler =
        ToolExecutionFailedHandler { _ -> }
     ...
     */
    public var toolExecutionCompletedHandler: ToolExecutionCompletedHandler =
        ToolExecutionCompletedHandler { _ -> }
}
 ...
 */
public fun interface ToolExecutionStartingHandler {
    /**
 ...
 */
public fun interface ToolValidationFailedHandler {
    /**
 ...
 */
public fun interface ToolExecutionFailedHandler {
    /**
 ...
 */
public fun interface ToolExecutionCompletedHandler {
    /**
