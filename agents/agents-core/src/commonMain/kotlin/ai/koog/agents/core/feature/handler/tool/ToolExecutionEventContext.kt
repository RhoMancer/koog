...
@Deprecated(
    message = "Scheduled for removal. Use ToolExecutionStartingContext instead",
    replaceWith = ReplaceWith("ToolExecutionStartingContext")
)
public typealias ToolCallStartingContext = ToolExecutionStartingContext

@Deprecated(
    message = "Scheduled for removal. Use ToolValidationFailedContext instead",
    replaceWith = ReplaceWith("ToolValidationFailedContext")
)
public typealias ToolCallValidationFailedContext = ToolValidationFailedContext

@Deprecated(
    message = "Scheduled for removal. Use ToolExecutionFailedContext instead",
    replaceWith = ReplaceWith("ToolExecutionFailedContext")
)
public typealias ToolCallFailedContext = ToolExecutionFailedContext

@Deprecated(
    message = "Scheduled for removal. Use ToolExecutionCompletedContext instead",
    replaceWith = ReplaceWith("ToolExecutionCompletedContext")
)
public typealias ToolCallResultContext = ToolExecutionCompletedContext
