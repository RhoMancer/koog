...
public class OpenTelemetry {
    ...
    public companion object Feature : AIAgentGraphFeature<OpenTelemetryConfig, OpenTelemetry> {
        ...
        private fun startCallToolSpan(
            ...
            val mcpTools = eventContext.context.llm.toolRegistry.tools
            val mcpTool = mcpTools.find { it.name == eventContext.toolName && it is McpTool } as? McpTool
            return if (mcpTool != null) {
                startMcpClientSpan(
                    ...
                    sessionId = mcpTool.serverDescription.sessionId,
                    requestId = null,
                    method = McpMethod.TOOLS_CALL,
                    serverPort = mcpTool.serverDescription.serverPort,
                    serverAddress = mcpTool.serverDescription.serverUrl,
                    mcpProtocolVersion = mcpTool.serverDescription.mcpProtocolVersion,
                    mcpTransportType = mcpTool.serverDescription.mcpTransportType,
                )
            } else {
        ...
        private suspend fun endAndRemoveToolCallSpan(
